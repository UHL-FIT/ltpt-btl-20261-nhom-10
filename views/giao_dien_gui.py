...
def tao_giao_dien_chinh(root):
    """Khởi tạo giao diện chính PyWarehouse."""
    ...
    lbl_tong_hang = tk.Label(status_bar, text="Sĩ số mặt hàng: 0", font=("Arial", 10, "bold"), bg="#dfe6e9")
    lbl_tong_hang.pack(side=tk.LEFT, padx=20)

    lbl_tong_von = tk.Label(status_bar, text="Tổng vốn: 0 VNĐ", font=("Arial", 10, "bold"), bg="#dfe6e9")
...
def hien_thi_form_nhap_lieu(parent, tieu_de, data_cu=None):
    """Cửa sổ phụ (Sub Window) để Thêm/Sửa sản phẩm."""
